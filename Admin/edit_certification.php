...
if ($index < 0 || !isset($certifications[$index])) {
...
<head>
    ...
    <title>Edit Certification | Admin</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data" action="edit_certification.php?id=<?php echo $index; ?>">
            <label for="title">Title</label>
            <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($cert['title']); ?>" required>
            <label for="desc">Description</label>
            <textarea id="desc" name="desc" required><?php echo htmlspecialchars($cert['desc']); ?></textarea>
            <label for="duration">Duration</label>
            <input type="text" id="duration" name="duration" value="<?php echo htmlspecialchars($cert['duration']); ?>" required>
            <label>Current Images</label>
            <div class="image-preview-list">
                <?php foreach ($cert['images'] as $i => $img): ?>
